-- Fix handle_new_user trigger to include affiliate fields
-- The cleanup_and_prepare_prod.sql migration accidentally overwrote the trigger
-- removing business_name, business_location, bank_alias, bank_holder fields
